 ...
 * which resulted in an HTTP 409 (Conflict). Usually this handler will be invoked whenever a
...
class ConflictHandler extends DefaultResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        throw new ConflictException("There is a conflict with the given data (is the revision up to date?)");
    }
}
